      ...
      <div className="resume-input-container input-div">
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div className="work-type-container">
            <button className={`work-type-btn ${'dark-green'}`}>강연</button>
            <button className={`work-type-btn ${'white'}`}>멘토링</button>
            <button className={`work-type-btn ${'white'}`}>외주</button>
            <button className={`work-type-btn ${'white'}`}>정규직</button>
          </div>
        </div>
        <div>
